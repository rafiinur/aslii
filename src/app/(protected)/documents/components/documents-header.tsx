...
const DocumentsHeader = () => {
  return (
    <div className="flex flex-col md:flex-row gap-4 items-end justify-between">
      <div className="">
        <h4 className="font-semibold text-lg text-neutral-1000">Dokumen</h4>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <div className="flex w-full justify-end gap-2">
                <Button className="bg-success-300 hover:bg-success-600 cursor-pointer">Upload</Button>
                <Button className="bg-error-300 hover:bg-error-600 cursor-pointer">Batal</Button>
              </div>
          </DialogContent>
        </Dialog>
      </div>
