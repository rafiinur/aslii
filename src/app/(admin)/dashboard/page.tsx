...
export default function DashboardPage() {
  return (
    <div className="flex flex-1 flex-col gap-6">
      <div className="grid auto-rows-min grid-cols-1 md:grid-cols-5 gap-6 min-h-0 flex-1">
        <div className="md:col-span-3 flex flex-col min-h-0 flex-1">
      ...
      <div className="grid auto-rows-min grid-cols-1 md:grid-cols-2 gap-6 min-h-0 flex-1">
