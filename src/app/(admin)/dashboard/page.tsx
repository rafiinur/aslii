...
export default function DashboardPage() {
  return (
    <div className="grid grid-cols-1 gap-6 h-full px-6 pb-4">
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <div className="md:col-span-2 flex flex-col">
          ...
          <div className="grid gap-6 grid-cols-2 flex-1 min-h-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 min-h-0">
        ...
        <div className="flex flex-col gap-2.5 h-full">
          <div className="flex items-center justify-between">
            <h4 className="section-title">Pengumuman Terbaru</h4>
